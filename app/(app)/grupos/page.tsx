...
import FormReparto from '@/app/components/FormReparto'
import Notificaciones from '@/app/components/Notificaciones'
import { SkeletonCard } from '@/app/components/Skeleton'
import { formatoMoneda, simboloMoneda } from '@/app/lib/dinero'
import { resumenMultimoneda, signoConjunto, type MontosPorMoneda } from '@/app/lib/grupos-resumen'
import { diasAntes, fechaHoyLocal } from '@/app/lib/fecha'
...
function RepartosPanel({ router, accion, setAccion, tab, cambiarTab }: {
  ...
  const generarLiquidacion = async (formato: 'pdf' | 'excel') => {
    ...
    try {
      ...
      const lib = await import('@/app/lib/exportar-liquidacion')
