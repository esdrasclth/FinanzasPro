...
import FormEditarTransaccion from '@/app/components/FormEditarTransaccion'
import Notificaciones from '@/app/components/Notificaciones'
import { SkeletonGrupoFecha } from '@/app/components/Skeleton'
import { useMoneda } from '@/app/lib/moneda-context'
import { totales, soloMovimientosReales, montoNormalizado } from '@/app/lib/finanzas'
import { simboloMoneda } from '@/app/lib/dinero'
import { eliminarTransaccion, tipoCompuesto, avisoBorrado } from '@/app/lib/transacciones'
...
export default function TransaccionesCliente({ mesInicial, transaccionesIniciales, categoriasIniciales, carterasIniciales, tasaInicial,
}: Props) {
