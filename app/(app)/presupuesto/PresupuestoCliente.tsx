...
import FormPresupuesto from '@/app/components/FormPresupuesto'
import FormMeta from '@/app/components/FormMeta'
import FormAporteMeta from '@/app/components/FormAporteMeta'
...
export default function PresupuestoCliente({ presupuestosIniciales, sinPresupuestoInicial, gastoPrevInicial, categoriasIniciales, metasIniciales,
  ...
  const cargarPresupuestos = useCallback(async () => {
    ...
    const params = new URLSearchParams({
      ...
      actual: mesOffset === 0 ? '1' : '0',
    })
    try {
      const res = await fetch(`/api/presupuesto?${params}`)
      if (!res.ok) return
      ...
      <div className="max-w-[1728px] p-4 mx-auto sm:p-6 lg:p-8">
        ...
        <div className="flex items-start justify-between mb-5 sm:mb-8">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-obsidian">Planifica y controla tus metas</h1>
          </div>
